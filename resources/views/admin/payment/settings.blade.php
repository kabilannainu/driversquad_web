                ...
                <div class="card card-block card-inverse card-primary">
                    <blockquote class="card-blockquote">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-6">
                                <input @if(Setting::get('razorpay') == 1) checked  @endif  name="razorpay" id="razor_check" onchange="razorselect()" type="checkbox" class="js-switch" data-color="#43b968">
                            </div>
                        </div>
                        <div id="razor_field" @if(Setting::get('razorpay') == 0) style="display: none;" @endif>
                            <div class="form-group row">
                                <label for="rzp_secret" class="col-xs-4 col-form-label">Rzp Secret</label>
                                <div class="col-xs-8">
                                    <input class="form-control" type="text" value="{{Setting::get('rzp_secret', '') }}" name="rzp_secret" id="rzp_secret"  placeholder="Secret key">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="rzp_key" class="col-xs-4 col-form-label">Rzp Key</label>
                                <div class="col-xs-8">
                                    <input class="form-control" type="text" value="{{Setting::get('rzp_key', '') }}" name="rzp_key" id="rzp_key"  placeholder="Rzp key">
                                </div>
                            </div>
                        </div>
                    </blockquote>
